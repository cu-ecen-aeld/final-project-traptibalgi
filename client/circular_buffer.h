...
#define AESDCHAR_MAX_WRITE_OPERATIONS_SUPPORTED 100
#define HRES (640)
#define VRES (480)
...
struct aesd_circular_buffer
{
    ...
    char buffer_storage[AESDCHAR_MAX_WRITE_OPERATIONS_SUPPORTED][FRAME_SIZE];
};
...
extern const struct aesd_buffer_entry* aesd_circular_buffer_read_and_remove(struct aesd_circular_buffer *buffer);
